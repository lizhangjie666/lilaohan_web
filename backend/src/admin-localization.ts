...
const contentTypeLocalizations: Record<string, ModelLocalization> = {
  'api::product.product': {
    ...
    image: { label: '产品图片' },
    imageAlt: { label: '图片替代文字', placeholder: '简短说明图片中真实展示的内容。' },
    seo: { label: '搜索展示设置' },
  },
  ...
  'api::site-setting.site-setting': {
    ...
    heroImageAlt: { label: '首页主图替代文字' },
    homeFireImage: { label: '首页窑炉故事图' },
    homeFireImageAlt: { label: '窑炉故事图替代文字' },
    menuHeroImage: { label: '菜单页主图' },
    menuHeroImageAlt: { label: '菜单页主图替代文字' },
    diyHeroImage: { label: '手作体验页主图' },
    diyHeroImageAlt: { label: '手作体验页主图替代文字' },
    guideHeroImage: { label: '打卡指南页主图' },
    guideHeroImageAlt: { label: '打卡指南页主图替代文字' },
    address: { label: '完整地址' },
    hours: { label: '营业时间' },
    phone: { label: '咨询电话' },
    wechat: { label: '对外微信号' },
    wechatQr: { label: '微信二维码' },
    wechatQrAlt: { label: '微信二维码替代文字' },
  ...
  'api::story.story': {
    ...
    heroImageAlt: { label: '品牌故事主图替代文字' },
    teamImage: { label: '店主与团队图片' },
    teamImageAlt: { label: '团队图片替代文字' },
    gallery: { label: '故事图库' },
    visible: { label: '官网显示' },
    seo: { label: '搜索展示设置' },
  },
