...
- 手作项目目录及主推面包介绍页的页头、准备说明、理念、四阶段故事、镇山村画廊、顾客作品墙和预约区统一在“页面板块”维护；赠品和主推教程在“手作体验设置”维护
...
- 手机访问单个体验介绍页时使用不含价格的“添加微信预约”固定栏；项目目录和教程页使用全站默认快捷栏
...
- 面包、披萨及未来手作体验均不在后台、接口、SEO或前台展示价格；预约赠品可以保留，但文案不得包含金额
