...
<template>
  <div>
    <section class="relative isolate min-h-[82vh] overflow-hidden bg-ink text-white">
      <ContentImage :image="blocks.hero.image || site?.heroImage" :alt="blocks.hero.image ? blocks.hero.imageAlt : site?.heroImageAlt" class="absolute inset-0 -z-20 h-full w-full object-cover object-[55%_48%]" loading="eager" fetchpriority="high" />
