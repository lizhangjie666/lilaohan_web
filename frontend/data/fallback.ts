...
export const fallbackTutorials: Tutorial[] = [
  ...
  { id: 4, slug: 'tie-dye', title: '扎染体验', type: '扎染', experienceStatus: '内容筹备中', summary: '项目内容正在筹备中，具体开放时间与体验安排请添加门店微信咨询。', duration: '', people: '', materials: [], ingredients: [], tools: [], steps: [], tutorialChapters: [], notes: [], imageAlt: '扎染体验图片' },
]
