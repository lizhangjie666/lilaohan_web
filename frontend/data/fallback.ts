...
export const fallbackTutorials: Tutorial[] = [
  { id: 1, slug: 'bread-diy', title: '亲手做一只窑烤面包', type: '面包 DIY', experienceStatus: '开放体验', summary: '从认识面团、整形到送进窑炉，带走一份自己参与完成的出炉记忆。', duration: '时长待确认', people: '亲子、朋友、团建；接待人数待确认', materials: ['面团与配料由门店准备', '围裙与基础工具', '成品包装'], ingredients: [], tools: [], steps: [{ title: '认识面团', description: '了解当天面团状态与窑烤方式。' }, { title: '整形与装饰', description: '在指导下完成整形和表面装饰。' }, { title: '入窑烘烤', description: '由工作人员操作窑炉，等待面包上色。' }, { title: '出炉带走', description: '拍照、品尝并带走自己的作品。' }], notes: ['具体流程以门店现场安排为准', '儿童需由监护人陪同', '如有食物过敏，请提前告知'], image: images.bread, imageAlt: '手作面包氛围示意图，待替换为真实DIY照片' },
  { id: 2, slug: 'pizza-diy', title: '做一张属于自己的窑烤披萨', type: '披萨 DIY', experienceStatus: '开放体验', summary: '擀开面团、挑选配料、亲手铺满，再看它在窑火里快速鼓起。', duration: '时长待确认', people: '亲子、朋友、团建；接待人数待确认', materials: ['披萨面团', '当日配料', '围裙与基础工具'], ingredients: [], tools: [], steps: [{ title: '擀开面团', description: '学习把面团整理成适合入窑的形状。' }, { title: '铺上配料', description: '按照口味选择当天可用的配料。' }, { title: '送入窑炉', description: '由工作人员完成高温窑炉操作。' }, { title: '一起分享', description: '出炉后切开品尝，记录自己的成品。' }], notes: ['配料会随季节和库存调整', '高温窑炉区域请听从工作人员指引'], image: images.pizza, imageAlt: '披萨制作氛围示意图，待替换为真实DIY照片' },
  { id: 3, slug: 'cookie-diy', title: '饼干 DIY 体验', type: '饼干 DIY', experienceStatus: '内容筹备中', summary: '项目内容正在筹备中，具体开放时间与体验安排请添加门店微信咨询。', duration: '', people: '', materials: [], ingredients: [], tools: [], steps: [], notes: [], imageAlt: '饼干 DIY 体验图片' },
  { id: 4, slug: 'tie-dye', title: '扎染体验', type: '扎染', experienceStatus: '内容筹备中', summary: '项目内容正在筹备中，具体开放时间与体验安排请添加门店微信咨询。', duration: '', people: '', materials: [], ingredients: [], tools: [], steps: [], notes: [], imageAlt: '扎染体验图片' },
]
