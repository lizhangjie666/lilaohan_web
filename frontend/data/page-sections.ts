...
export const pageSectionDefaults: Record<string, PageSection> = {
  ...
  'home.diy': section('home.diy', { eyebrow: '02 · 亲手做一次', title: '把“我来过”\n变成“我做过”。', description: '揉面、铺料、等待出炉。手作体验不是观看节目，而是一起完成一份可以吃掉的旅行记忆。', primaryButtonText: '查看全部体验', primaryButtonLink: '/diy' }),
  'home.guide': section('home.guide', { eyebrow: '03 · WALK INTO THE VILLAGE', title: '从店里出发，\n走进镇山村。', description: '把等面包出炉的时间，留给湖边、石板路和村子的风。所有机位将在店主实地核实后正式发布。', primaryButtonText: '打开半日打卡指南 →', primaryButtonLink: '/guide' }),
  ...
  'diy-catalog.hero': section('diy-catalog.hero', { eyebrow: 'MAKE IT YOURSELF', title: '挑一个喜欢的手作体验。', description: '从面包到披萨，每个项目都有独立的体验介绍和步骤教程。' }),
  'diy-catalog.list': section('diy-catalog.list', { eyebrow: 'DIY EXPERIENCES', title: '今天，想亲手做什么？', description: '点击卡片了解体验内容，或直接查看详细教程。' }),
  'diy-catalog.empty': section('diy-catalog.empty', { title: '手作体验正在整理', description: '新的体验项目准备好后会在这里发布。' }),
  ...
  'diy.value': section('diy.value', { eyebrow: 'WHAT YOU GET', title: '这次可以体验什么？', description: '自己做的面包，就是最好吃的。', items: [{ title: '一份面团', text: '每位体验者都有一份属于自己的面团。' }, { title: '自由造型', text: '不限制固定造型，把想象变成可以带回家的面包。' }, { title: '配料与工具', text: '基础配料与制作工具由门店准备。' }] }),
