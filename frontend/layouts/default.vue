  ...
  <div class="min-h-screen pb-20 md:pb-0">
    ...
    <footer class="bg-ink pb-24 pt-14 text-flour md:pb-14">
      <div class="page-wrap grid gap-10 md:grid-cols-[1.4fr_1fr_1fr]">
        <div><p class="font-serif text-3xl">等一炉面包，逛一座村子。</p><p class="mt-4 max-w-md text-sm leading-7 text-flour/65">贵州省贵阳市花溪区镇山村 · 店铺门牌、营业时间与联系方式待店主在后台确认。</p></div>
        ...
        <div><p class="text-xs tracking-[0.2em] text-flour/50">PHOTO CREDIT</p><p class="mt-4 text-xs leading-6 text-flour/55">临时素材：Chensiyuan / CC BY-SA 4.0；Beboplu、Drew Coffman / CC0。正式上线前替换为门店与镇山村实拍。</p></div>
      </div>
    </footer>
